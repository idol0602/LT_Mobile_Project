...
export const API_BASE = "http://192.168.1.64:5050"; // DataServer running on 192.168.2.63:5000

// Utils Server for AI features (chat, translate, pronoun recognition)
export const UTILS_BASE = "http:/192.168.1.64:3000"; // Utils Server running on 192.168.2.63:3000
