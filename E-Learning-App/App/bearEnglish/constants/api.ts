...
export const API_BASE = "http://172.20.34.159:5050"; // DataServer running on 192.168.1.52:5050

// Utils Server for AI features (chat, translate, pronoun recognition)
export const UTILS_BASE = "http://172.20.34.159:3000"; // Utils Server running on 192.168.1.52:3000
